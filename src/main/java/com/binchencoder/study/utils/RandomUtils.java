...
public class RandomUtils {
    ...
    /**
     * 根据传入的数字值与52个字符一一对应, 组合成string
     *
     * @param num 长整形数字
     * @return
     */
    public static String getStringCorrespondNum(long num) {
        if (num == 0) {
            return "";
        }
        ...
        for (int i = 0; i < chars.length; i++) {
            String idx = String.valueOf(chars[i]);
            sb.append(LETTERCHAR.charAt(Integer.valueOf(idx)));
        }
        return sb.toString();
    }
